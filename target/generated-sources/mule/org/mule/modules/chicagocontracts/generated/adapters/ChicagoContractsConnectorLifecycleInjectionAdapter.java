...
/**
 * A <code>ChicagoContractsConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link ChicagoContractsConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-10-03T12:46:54-04:00", comments = "Build UNNAMED.2793.f49b6c7")
public class ChicagoContractsConnectorLifecycleInjectionAdapter
    extends ChicagoContractsConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(ChicagoContractsConnectorLifecycleInjectionAdapter.class);
