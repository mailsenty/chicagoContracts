...
public class FindOnStartDateMessageProcessorDebuggable
    extends FindOnStartDateMessageProcessor
    implements DebugInfoProvider
{


    public FindOnStartDateMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("startDate", "Start date", (java.lang.String.class), startDate, muleEvent));
