...
public class FindOnEndDateMessageProcessorDebuggable
    extends FindOnEndDateMessageProcessor
    implements DebugInfoProvider
{


    public FindOnEndDateMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
