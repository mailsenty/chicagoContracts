...
public class FindOnZipMessageProcessorDebuggable
    extends FindOnZipMessageProcessor
    implements DebugInfoProvider
{


    public FindOnZipMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("zip", "Zip", (java.lang.String.class), zip, muleEvent));
