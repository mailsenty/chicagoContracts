...
public class FindOnVendorIdMessageProcessorDebuggable
    extends FindOnVendorIdMessageProcessor
    implements DebugInfoProvider
{


    public FindOnVendorIdMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("vendorId", "Vendor id", (java.lang.String.class), vendorId, muleEvent));
